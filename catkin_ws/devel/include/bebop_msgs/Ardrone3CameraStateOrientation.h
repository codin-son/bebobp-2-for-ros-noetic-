...
bool operator==(const ::bebop_msgs::Ardrone3CameraStateOrientation_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3CameraStateOrientation_<ContainerAllocator2> & rhs)
{
