...
bool operator==(const ::bebop_msgs::CommonCommonStateVideoRecordingTimestamp_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateVideoRecordingTimestamp_<ContainerAllocator2> & rhs)
{
