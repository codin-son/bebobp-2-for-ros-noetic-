...
bool operator==(const ::bebop_msgs::Ardrone3NetworkStateWifiScanListChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3NetworkStateWifiScanListChanged_<ContainerAllocator2> & rhs)
{
