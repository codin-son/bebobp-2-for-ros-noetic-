...
struct CommonCommonStateCountryListKnown_
{
  ...
  _listFlags_type listFlags;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _countryCodes_type;
...
bool operator==(const ::bebop_msgs::CommonCommonStateCountryListKnown_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateCountryListKnown_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.listFlags == rhs.listFlags &&
...
struct Printer< ::bebop_msgs::CommonCommonStateCountryListKnown_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::bebop_msgs::CommonCommonStateCountryListKnown_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.countryCodes);
  }
};
