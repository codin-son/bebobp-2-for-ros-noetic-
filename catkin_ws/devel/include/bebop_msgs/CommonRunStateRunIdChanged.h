...
struct CommonRunStateRunIdChanged_
{
  ...
  _header_type header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _runId_type;
  _runId_type runId;
...
bool operator==(const ::bebop_msgs::CommonRunStateRunIdChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonRunStateRunIdChanged_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::bebop_msgs::CommonRunStateRunIdChanged_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::bebop_msgs::CommonRunStateRunIdChanged_<ContainerAllocator>& v)
  {
    ...
    s << indent << "runId: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.runId);
  }
};
