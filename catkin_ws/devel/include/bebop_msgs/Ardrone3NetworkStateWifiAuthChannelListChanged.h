...
#if defined(_WIN32) && defined(band_2_4ghz)
  #undef band_2_4ghz
#endif
#if defined(_WIN32) && defined(band_5ghz)
  #undef band_5ghz
#endif
...
bool operator==(const ::bebop_msgs::Ardrone3NetworkStateWifiAuthChannelListChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3NetworkStateWifiAuthChannelListChanged_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.band == rhs.band &&
    lhs.channel == rhs.channel &&
    lhs.in_or_out == rhs.in_or_out;
}
