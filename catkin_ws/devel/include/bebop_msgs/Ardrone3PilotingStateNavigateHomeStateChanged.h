...
#if defined(_WIN32) && defined(state_available)
  #undef state_available
#endif
#if defined(_WIN32) && defined(state_inProgress)
  #undef state_inProgress
#endif
#if defined(_WIN32) && defined(state_unavailable)
  #undef state_unavailable
#endif
#if defined(_WIN32) && defined(state_pending)
  #undef state_pending
#endif
#if defined(_WIN32) && defined(reason_userRequest)
  #undef reason_userRequest
#endif
#if defined(_WIN32) && defined(reason_connectionLost)
  #undef reason_connectionLost
#endif
#if defined(_WIN32) && defined(reason_lowBattery)
  #undef reason_lowBattery
#endif
#if defined(_WIN32) && defined(reason_finished)
  #undef reason_finished
#endif
#if defined(_WIN32) && defined(reason_stopped)
  #undef reason_stopped
#endif
#if defined(_WIN32) && defined(reason_disabled)
  #undef reason_disabled
#endif
#if defined(_WIN32) && defined(reason_enabled)
  #undef reason_enabled
#endif
...
bool operator==(const ::bebop_msgs::Ardrone3PilotingStateNavigateHomeStateChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3PilotingStateNavigateHomeStateChanged_<ContainerAllocator2> & rhs)
{
