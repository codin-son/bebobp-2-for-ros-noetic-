...
bool operator==(const ::bebop_msgs::Ardrone3GPSStateHomeTypeChosenChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3GPSStateHomeTypeChosenChanged_<ContainerAllocator2> & rhs)
{
