...
struct Ardrone3AccessoryStateConnectedAccessories_
{
  ...
  _uid_type uid;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _swVersion_type;
...
struct Printer< ::bebop_msgs::Ardrone3AccessoryStateConnectedAccessories_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::bebop_msgs::Ardrone3AccessoryStateConnectedAccessories_<ContainerAllocator>& v)
  {
    ...
    s << indent << "swVersion: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.swVersion);
  }
};
