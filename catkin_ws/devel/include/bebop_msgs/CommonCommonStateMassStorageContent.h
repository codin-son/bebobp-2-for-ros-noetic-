...
bool operator==(const ::bebop_msgs::CommonCommonStateMassStorageContent_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateMassStorageContent_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.nbRawPhotos == rhs.nbRawPhotos;
}
