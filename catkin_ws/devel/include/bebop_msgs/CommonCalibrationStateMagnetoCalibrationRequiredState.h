...
bool operator==(const ::bebop_msgs::CommonCalibrationStateMagnetoCalibrationRequiredState_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCalibrationStateMagnetoCalibrationRequiredState_<ContainerAllocator2> & rhs)
{
