...
bool operator==(const ::bebop_msgs::Ardrone3PilotingStatePositionChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3PilotingStatePositionChanged_<ContainerAllocator2> & rhs)
{
