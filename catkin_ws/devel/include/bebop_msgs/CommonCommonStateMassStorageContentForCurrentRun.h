...
bool operator==(const ::bebop_msgs::CommonCommonStateMassStorageContentForCurrentRun_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateMassStorageContentForCurrentRun_<ContainerAllocator2> & rhs)
{
