...
bool operator==(const ::bebop_msgs::CommonAudioStateAudioStreamingRunning_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonAudioStateAudioStreamingRunning_<ContainerAllocator2> & rhs)
{
