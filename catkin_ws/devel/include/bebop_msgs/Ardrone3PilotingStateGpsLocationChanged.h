...
bool operator==(const ::bebop_msgs::Ardrone3PilotingStateGpsLocationChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3PilotingStateGpsLocationChanged_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.latitude == rhs.latitude &&
    lhs.longitude == rhs.longitude &&
    lhs.altitude == rhs.altitude &&
    lhs.latitude_accuracy == rhs.latitude_accuracy &&
    lhs.longitude_accuracy == rhs.longitude_accuracy &&
    lhs.altitude_accuracy == rhs.altitude_accuracy;
}
