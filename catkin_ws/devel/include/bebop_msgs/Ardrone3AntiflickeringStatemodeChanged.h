...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef mode_auto
#endif
#if defined(_WIN32) && defined(mode_FixedFiftyHertz)
  #undef mode_FixedFiftyHertz
#endif
#if defined(_WIN32) && defined(mode_FixedSixtyHertz)
  #undef mode_FixedSixtyHertz
#endif
...
bool operator==(const ::bebop_msgs::Ardrone3AntiflickeringStatemodeChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3AntiflickeringStatemodeChanged_<ContainerAllocator2> & rhs)
{
