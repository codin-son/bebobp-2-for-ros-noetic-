...
bool operator==(const ::bebop_msgs::CommonAccessoryStateAccessoryConfigModificationEnabled_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonAccessoryStateAccessoryConfigModificationEnabled_<ContainerAllocator2> & rhs)
{
