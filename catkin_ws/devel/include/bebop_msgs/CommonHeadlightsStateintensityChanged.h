...
bool operator==(const ::bebop_msgs::CommonHeadlightsStateintensityChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonHeadlightsStateintensityChanged_<ContainerAllocator2> & rhs)
{
