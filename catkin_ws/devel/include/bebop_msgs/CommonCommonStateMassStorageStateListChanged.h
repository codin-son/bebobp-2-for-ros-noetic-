...
bool operator==(const ::bebop_msgs::CommonCommonStateMassStorageStateListChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateMassStorageStateListChanged_<ContainerAllocator2> & rhs)
{
