...
bool operator==(const ::bebop_msgs::CommonCommonStateAllStatesChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateAllStatesChanged_<ContainerAllocator2> & rhs)
{
