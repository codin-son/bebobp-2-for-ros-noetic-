...
bool operator==(const ::bebop_msgs::Ardrone3CameraStateVelocityRange_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3CameraStateVelocityRange_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.max_tilt == rhs.max_tilt &&
    lhs.max_pan == rhs.max_pan;
}
