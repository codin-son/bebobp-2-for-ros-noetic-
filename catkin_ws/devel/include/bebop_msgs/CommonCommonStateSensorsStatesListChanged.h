...
#if defined(_WIN32) && defined(sensorName_IMU)
  #undef sensorName_IMU
#endif
#if defined(_WIN32) && defined(sensorName_barometer)
  #undef sensorName_barometer
#endif
#if defined(_WIN32) && defined(sensorName_ultrasound)
  #undef sensorName_ultrasound
#endif
#if defined(_WIN32) && defined(sensorName_GPS)
  #undef sensorName_GPS
#endif
#if defined(_WIN32) && defined(sensorName_magnetometer)
  #undef sensorName_magnetometer
#endif
#if defined(_WIN32) && defined(sensorName_vertical_camera)
  #undef sensorName_vertical_camera
#endif
...
bool operator==(const ::bebop_msgs::CommonCommonStateSensorsStatesListChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateSensorsStatesListChanged_<ContainerAllocator2> & rhs)
{
