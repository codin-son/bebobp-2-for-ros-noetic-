...
bool operator==(const ::bebop_msgs::CommonCommonStateCurrentTimeChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateCurrentTimeChanged_<ContainerAllocator2> & rhs)
{
