...
bool operator==(const ::bebop_msgs::CommonCalibrationStateMagnetoCalibrationStateChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCalibrationStateMagnetoCalibrationStateChanged_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.xAxisCalibration == rhs.xAxisCalibration &&
    lhs.yAxisCalibration == rhs.yAxisCalibration &&
    lhs.zAxisCalibration == rhs.zAxisCalibration &&
    lhs.calibrationFailed == rhs.calibrationFailed;
}
