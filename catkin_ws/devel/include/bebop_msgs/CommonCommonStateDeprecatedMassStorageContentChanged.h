...
bool operator==(const ::bebop_msgs::CommonCommonStateDeprecatedMassStorageContentChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateDeprecatedMassStorageContentChanged_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.mass_storage_id == rhs.mass_storage_id &&
    lhs.nbPhotos == rhs.nbPhotos &&
    lhs.nbVideos == rhs.nbVideos &&
    lhs.nbPuds == rhs.nbPuds &&
    lhs.nbCrashLogs == rhs.nbCrashLogs;
}
