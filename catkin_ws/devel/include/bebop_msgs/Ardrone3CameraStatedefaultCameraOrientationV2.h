...
bool operator==(const ::bebop_msgs::Ardrone3CameraStatedefaultCameraOrientationV2_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3CameraStatedefaultCameraOrientationV2_<ContainerAllocator2> & rhs)
{
