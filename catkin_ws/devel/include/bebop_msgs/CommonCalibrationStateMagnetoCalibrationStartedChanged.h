...
bool operator==(const ::bebop_msgs::CommonCalibrationStateMagnetoCalibrationStartedChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCalibrationStateMagnetoCalibrationStartedChanged_<ContainerAllocator2> & rhs)
{
