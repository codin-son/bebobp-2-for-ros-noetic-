...
bool operator==(const ::bebop_msgs::CommonCommonStateMassStorageInfoStateListChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonCommonStateMassStorageInfoStateListChanged_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.mass_storage_id == rhs.mass_storage_id &&
    lhs.size == rhs.size &&
    lhs.used_size == rhs.used_size &&
    lhs.plugged == rhs.plugged &&
    lhs.full == rhs.full &&
