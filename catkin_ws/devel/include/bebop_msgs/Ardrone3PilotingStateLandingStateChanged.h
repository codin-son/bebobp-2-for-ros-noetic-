...
#if defined(_WIN32) && defined(state_linear)
  #undef state_linear
#endif
#if defined(_WIN32) && defined(state_spiral)
  #undef state_spiral
#endif
...
bool operator==(const ::bebop_msgs::Ardrone3PilotingStateLandingStateChanged_<ContainerAllocator1> & lhs, const ::bebop_msgs::Ardrone3PilotingStateLandingStateChanged_<ContainerAllocator2> & rhs)
{
