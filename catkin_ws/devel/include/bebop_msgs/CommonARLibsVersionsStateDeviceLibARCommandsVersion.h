...
bool operator==(const ::bebop_msgs::CommonARLibsVersionsStateDeviceLibARCommandsVersion_<ContainerAllocator1> & lhs, const ::bebop_msgs::CommonARLibsVersionsStateDeviceLibARCommandsVersion_<ContainerAllocator2> & rhs)
{
